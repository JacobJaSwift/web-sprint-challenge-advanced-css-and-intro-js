...
function getArtistByIndex(array, index) {
    /* code here */
    return `The arist at ${index} is ${array[index].name}`;
  }
  console.log(getArtistByIndex(artists, 2));
  /**


orn in and died in 20th century (1900-2000) example born in 1901 and died in 1959 - included / born in 1889 and died in 1925 not included - should return ["Salvador Dali", "/* Task 4: Create a function called get20s() that takes data as an argument and returns an array with names of artists who were bFrida Kahlo"]*/

function get20s(year){

  /* Code here */
  for(let i = 0; i < artists.length;i++){ 
    if(artists[i].years.substring(1,2) === "9"){
      console.log(artists[i].name + " " + artists[i].years);
    } 
  }
}
...
function addArtist(id, name, years, genre, nationality, bio){
  ...
  addArtist(20, "Jacob Swift", "1993-2020", "Web Design", "American", "A man of very few lines");
